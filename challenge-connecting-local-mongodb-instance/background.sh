...
https://github.com/neelabalan/mongodb-sample-dataset/raw/main/sample_airbnb/listingsAndReviews.json
sudo dpkg -i mongodb-org-*
systemctl start mongod
apt install mongo-tools -y
sleep 3;
mongo localhost:27017/module1 --eval "db.createUser({user:'db_admin', pwd:'gswmongo', roles: ['dbAdmin']})";
